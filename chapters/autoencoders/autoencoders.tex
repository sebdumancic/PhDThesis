...
To allow for comparing the latent \gls{mln} with the baseline model, once the structure is learned in the latent space we add the corresponding decoder clauses from \alp{s} to the latent model.
