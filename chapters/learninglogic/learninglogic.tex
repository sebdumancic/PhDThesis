...
To reduce a problem in MVR, say the data in Table \ref{tab:pets}, to the BR, we have to introduce a new variable for each \textit{attribute-value} pair, e.g., \textit{fluffiness = 4}.
