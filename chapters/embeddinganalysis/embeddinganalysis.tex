\chapter{Towards a better understanding of relational latent representations}\label{ch:embeddinganalysis}
...
% 			\midrule
%
% 		\textbf{TILDE} 	& .875			& .879				& .893			  	& .76			& .76				& .76 \\
% 		\midrule
%
% 		\midrule
...
% On the FB15k-237 dataset, TILDE achieves the Hits@1 of .875 and Hits@10 of .893.
% Moreover, it achieves this performance with relatively simple trees containing 10.15 nodes on average.
% On the WN18-RR dataset, TILDE achieves the performance of .76 on all three metrics.
% However, the obtained trees are much more complex than the ones learned on FB15k-237 dataset, having on average 231 nodes.
% This difference comes from the properties of the dataset: FB15k-237 is a rather sparse dataset having a large number of relations (237), which WN18-RR is a dense dataset with only 11 relations.
%
%
%
