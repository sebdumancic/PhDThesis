...
\todo{but f o m is also a function of f, so: also doomed? How does this help?}
...
\newglossaryentry{lrnn}{name={LRNN},description={Lifted Relational Neural Networks}}
...
RelNN takes a different approach and constructs relational neural networks out of relational logistic regression models as a basic primitive.
Consequently, 
% TODO: finish RelNN
\todo{finish RelNN}
